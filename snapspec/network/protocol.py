...
class MessageType(str, Enum):
    ...
    RESTORE_ABORT = "RESTORE_ABORT"
    MARK_SNAPSHOT_COMMITTED = "MARK_SNAPSHOT_COMMITTED"
    GET_SNAPSHOT_MANIFESTS = "GET_SNAPSHOT_MANIFESTS"
    ...
    GET_WORKLOAD_STATS = "GET_WORKLOAD_STATS"
